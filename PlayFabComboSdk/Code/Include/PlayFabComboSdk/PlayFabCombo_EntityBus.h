...
#include <PlayFabComboSdk/PlayFabEntityDataModels.h>
#include <AzCore/EBus/EBus.h>

namespace PlayFabComboSdk
{
    class PlayFabCombo_EntityRequests
    ...
    using PlayFabCombo_EntityRequestBus = AZ::EBus<PlayFabCombo_EntityRequests>;
} // namespace PlayFabComboSdk
