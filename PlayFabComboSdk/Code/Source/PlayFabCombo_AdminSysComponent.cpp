...
namespace PlayFabComboSdk
{
    ...
    void PlayFabCombo_AdminSysComponent::CheckLimitedEditionItemAvailability(AdminModels::CheckLimitedEditionItemAvailabilityRequest& request, ProcessApiCallback<AdminModels::CheckLimitedEditionItemAvailabilityResult> callback, ErrorCallback errorCallback, void* customData)
    {
    ...
    void PlayFabCombo_AdminSysComponent::DeleteMasterPlayerAccount(AdminModels::DeleteMasterPlayerAccountRequest& request, ProcessApiCallback<AdminModels::DeleteMasterPlayerAccountResult> callback, ErrorCallback errorCallback, void* customData)
    {
    ...
    void PlayFabCombo_AdminSysComponent::DeleteTitle(ProcessApiCallback<AdminModels::DeleteTitleResult> callback, ErrorCallback errorCallback, void* customData)
    {
        PlayFabAdminApi::DeleteTitle(callback, errorCallback, customData);
    }
    void PlayFabCombo_AdminSysComponent::ExportMasterPlayerData(AdminModels::ExportMasterPlayerDataRequest& request, ProcessApiCallback<AdminModels::ExportMasterPlayerDataResult> callback, ErrorCallback errorCallback, void* customData)
    {
    ...
    void PlayFabCombo_AdminSysComponent::GetPlayedTitleList(AdminModels::GetPlayedTitleListRequest& request, ProcessApiCallback<AdminModels::GetPlayedTitleListResult> callback, ErrorCallback errorCallback, void* customData)
    {
        PlayFabAdminApi::GetPlayedTitleList(request, callback, errorCallback, customData);
    }
    void PlayFabCombo_AdminSysComponent::GetPlayerIdFromAuthToken(AdminModels::GetPlayerIdFromAuthTokenRequest& request, ProcessApiCallback<AdminModels::GetPlayerIdFromAuthTokenResult> callback, ErrorCallback errorCallback, void* customData)
    {
    ...
    void PlayFabCombo_AdminSysComponent::IncrementLimitedEditionItemAvailability(AdminModels::IncrementLimitedEditionItemAvailabilityRequest& request, ProcessApiCallback<AdminModels::IncrementLimitedEditionItemAvailabilityResult> callback, ErrorCallback errorCallback, void* customData)
    {
    ...
    void PlayFabCombo_AdminSysComponent::ResetPassword(AdminModels::ResetPasswordRequest& request, ProcessApiCallback<AdminModels::ResetPasswordResult> callback, ErrorCallback errorCallback, void* customData)
    {
