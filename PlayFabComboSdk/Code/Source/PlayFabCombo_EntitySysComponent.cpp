...
namespace PlayFabComboSdk
{
    ...
    void PlayFabCombo_EntitySysComponent::ExecuteEntityCloudScript(EntityModels::ExecuteEntityCloudScriptRequest& request, ProcessApiCallback<EntityModels::ExecuteCloudScriptResult> callback, ErrorCallback errorCallback, void* customData)
    {
    ...
    void PlayFabCombo_EntitySysComponent::WriteEvents(EntityModels::WriteEventsRequest& request, ProcessApiCallback<EntityModels::WriteEventsResponse> callback, ErrorCallback errorCallback, void* customData)
    {
