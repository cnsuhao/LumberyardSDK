...
#include <PlayFabServerSdk/PlayFabServer_ProfilesBus.h>

namespace PlayFabServerSdk
{
    class PlayFabServer_ProfilesSysComponent
        : public AZ::Component
        , protected PlayFabServer_ProfilesRequestBus::Handler
    {
    public:
        AZ_COMPONENT(PlayFabServer_ProfilesSysComponent, "{}");
    ...
    protected:
        ////////////////////////////////////////////////////////////////////////
        // PlayFabServer_ProfilesRequestBus interface implementation
