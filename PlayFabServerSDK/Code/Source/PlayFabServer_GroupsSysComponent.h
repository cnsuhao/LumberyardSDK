...
#include <PlayFabServerSdk/PlayFabServer_GroupsBus.h>

namespace PlayFabServerSdk
{
    class PlayFabServer_GroupsSysComponent
        : public AZ::Component
        , protected PlayFabServer_GroupsRequestBus::Handler
    {
    public:
        AZ_COMPONENT(PlayFabServer_GroupsSysComponent, "{}");
    ...
    protected:
        ////////////////////////////////////////////////////////////////////////
        // PlayFabServer_GroupsRequestBus interface implementation
