...
#include <PlayFabServerSdk/PlayFabProfilesDataModels.h>
#include <AzCore/EBus/EBus.h>

namespace PlayFabServerSdk
{
    class PlayFabServer_ProfilesRequests
    ...
    using PlayFabServer_ProfilesRequestBus = AZ::EBus<PlayFabServer_ProfilesRequests>;
} // namespace PlayFabServerSdk
