...
#include <PlayFabClientSdk/PlayFabGroupsDataModels.h>
#include <AzCore/EBus/EBus.h>

namespace PlayFabClientSdk
{
    class PlayFabClient_GroupsRequests
    ...
    using PlayFabClient_GroupsRequestBus = AZ::EBus<PlayFabClient_GroupsRequests>;
} // namespace PlayFabClientSdk
