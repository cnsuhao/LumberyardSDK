...
namespace PlayFabClientSdk
{
    ...
    struct PlayFabBaseModel
    {
        ...
        virtual void writeJSON(PFStringJsonWriter& writer) const = 0;
        virtual bool readFromValue(const rapidjson::Value& obj) = 0;

        AZStd::string toJSONString() const;
    ...
    inline AZStd::string PlayFabBaseModel::toJSONString() const
    {
    ...
    inline void MultitypeVar::writeJSON(PFStringJsonWriter& writer) const
    {
        switch (mType)
        {
        case MultitypeNull:
