...
#include <PlayFabClientSdk/PlayFabClient_DataBus.h>

namespace PlayFabClientSdk
{
    class PlayFabClient_DataSysComponent
        : public AZ::Component
        , protected PlayFabClient_DataRequestBus::Handler
    {
    public:
        AZ_COMPONENT(PlayFabClient_DataSysComponent, "{}");
    ...
    protected:
        ////////////////////////////////////////////////////////////////////////
        // PlayFabClient_DataRequestBus interface implementation
